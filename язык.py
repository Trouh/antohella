hikka_security:
    ...
    pm: "🤙 В лс"
    owner_list: "<emoji document_id=5386399931378440814>🍒</emoji> <b>Накончал </b> <code>в</code><b>:</b>\n\n{}"
    no_owner: "<emoji document_id=5386399931378440814>🍒</emoji> <b>Нет пользователей в группе</b> <code>owner</code>"
    no_user: "<emoji document_id=5210952531676504517>🍌</emoji> <b>Покажи куда накончать</b>"
    not_a_user: "<emoji document_id=5447644880824181073>⚠️</emoji> <b>Указанная цель - не пользователь</b>"
    cancel: "Сдержаться🚫"
    confirm: "Кончить💦"
    self: "<emoji document_id=5447644880824181073>⚠️</emoji> <b>Нельзя кончить на себя!</b>"
    warning: "⚠️ <b>Ты действительно хочешь накончать на <a href=\"tg://user?id={}\">{}</a> в группу</b> <code>{}</code><b>!\nЭто действие может родить детей пользователю!</b>"
    suggest_nonick: "💦 <i>Хочешь ли ты кончить ещё раз пользователю?</i>"
    user_nn: '💦 <b>Вы кончили <a href="tg://user?id={}">{}</a> дважды</b>'
    enable_nonick_btn: "Кончить💦"
    owner_added: '<emoji document_id="5386399931378440814">💦</emoji> <b><a href="tg://user?id={}">{}</a> обкончан</b> <code>owner</code>'
    owner_removed: '<emoji document_id="5386399931378440814">😎</emoji> <b><a href="tg://user?id={}">{}</a> вымыт от спермы</b> <code>owner</code>'
...
hikka_backup:
    ...
    reply_to_file: "<emoji document_id=5210952531676504517>🚫</emoji> <b>Еблан файл укажи</b>"
...
hikka_config:
    choose_core: "🍇 <b>Выбери порнушку</b>"
    configure: "🍇 <b>Просмотр порнушки</b>"
    configure_lib: "🌶 <b>Выбери ненужную хуету</b>"
    configuring_mod: "⚙️ <b>Выбери параметр для модуля</b> <code>{}</code>\n\n<b>Текущие настройки:</b>\n\n{}"
    configuring_lib: "📦 <b>Выбери параметр для библиотеки</b> <code>{}</code>\n\n<b>Текущие настройки:</b>\n\n{}"
    configuring_option: "⚙️ <b>Управление параметром</b> <code>{}</code> <b>модуля</b> <code>{}</code>\n<i>ℹ️ {}</i>\n\n<b>Стандартное: {}</b>\n\n<b>Текущее: {}</b>\n\n{}"
    configuring_option_lib: "📦 <b>Управление параметром</b> <code>{}</code> <b>библиотеки</b> <code>{}</code>\n<i>ℹ️ {}</i>\n\n<b>Стандартное: {}</b>\n\n<b>Текущее: {}</b>\n\n{}"
    option_saved: "<emoji document_id=5318933532825888187>⚙️</emoji> <b>Параметр</b> <code>{}</code> <b>модуля</b> <code>{}</code><b> сохранен!</b>\n<b>Текущее: {}</b>"
...
unit_heta:
    ...
    resolving_hash: "<emoji document_id=5325731315004218660>🍒</emoji> <b>Качаю...</b>"
    installing_from_hash: "<emoji document_id=5325731315004218660>🍒</emoji> <b>Качаю...</b> <code>{}</code> <b>...</b>"
...
help:
    undoc: "🦥 Нет описания"
    all_header: "<emoji document_id=5188377234380954537>💣</emoji> <b>{} Модулей взорвано"
...
loader:
    ...
    provide_module: "<emoji document_id=5312383351217201533>⚠️</emoji> <b>Еблан, модуль укажи</b>"
    ...
    no_class: "<b>Еблан, а что удалять то мне?</b>"
    ...
    requirements_installing: "<emoji document_id=5328311576736833844>💣</emoji> <b>Устанавливаю закладки:\n\n{}</b>"
